...
public class CreateOrdersTests extends BaseTest {
    ...
    private static final OrdersCreator ORDER_HELPER = new OrdersCreator();

    @Test
    @Description("Test order creation with ingredients and authorization")
    @DisplayName("Order creation with ingredients, with auth")
    public void testOrdersWithIngredientsAndWithAuthorization() {
    ...
    public void testOrdersWithIngredientsAndWithoutAuthorization() {
        // Определяем ингредиенты для заказа
        List<String> ingredients = new ArrayList<>();
    ...
    public void testOrdersWithoutIngredientsAndWithAuthorization() {
        User user = USER_HELPER.createUserObject();
        Response responseCreateUser = USER_HELPER.createUser(user);
        Response loginResponse = USER_HELPER.loginUser(user.getEmail(), user.getPassword());
        String accessToken = USER_HELPER.getUserAccessToken(loginResponse);
    ...
    public void testOrdersWithoutIngredientsAndWithoutAuthorization() {
//      Определяем ингредиенты для заказа
        List<String> ingredients = new ArrayList<>();
    ...
    public void testOrdersWithWrongIngredientsAndWithoutAuthorization() {
    ...
    public void testOrdersWithWrongIngredientsAndWithAuthorization() {
        User user = USER_HELPER.createUserObject();
        Response responseCreateUser = USER_HELPER.createUser(user);
        Response loginResponse = USER_HELPER.loginUser(user.getEmail(), user.getPassword());
        String accessToken = USER_HELPER.getUserAccessToken(loginResponse);
